...
execute if entity @s[y_rotation=270] positioned ~-0.2 ~0.1 ~ run tp @e[type=chest_minecart,tag=try_end_box,distance=..0.3,limit=1] ~ ~ ~ ~-90 ~
execute if entity @s[y_rotation=0] positioned ~ ~0.1 ~-0.2 run tp @e[type=chest_minecart,tag=try_end_box,distance=..0.3,limit=1] ~ ~ ~ ~-90 ~
execute if entity @s[y_rotation=90] positioned ~0.2 ~0.1 ~ run tp @e[type=chest_minecart,tag=try_end_box,distance=..0.3,limit=1] ~ ~ ~ ~-90 ~
execute if entity @s[y_rotation=180] positioned ~ ~0.1 ~0.2 run tp @e[type=chest_minecart,tag=try_end_box,distance=..0.3,limit=1] ~ ~ ~ ~-90 ~
