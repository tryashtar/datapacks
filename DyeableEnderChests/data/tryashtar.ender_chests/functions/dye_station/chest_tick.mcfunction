...
execute if entity @s[y_rotation=270] run tp @e[type=chest_minecart,tag=try_end_box,distance=..0.9,limit=1] ~-0.2 ~0.1 ~ ~-90 ~
execute if entity @s[y_rotation=0] run tp @e[type=chest_minecart,tag=try_end_box,distance=..0.9,limit=1] ~ ~0.1 ~-0.2 ~-90 ~
execute if entity @s[y_rotation=90] run tp @e[type=chest_minecart,tag=try_end_box,distance=..0.9,limit=1] ~0.2 ~0.1 ~ ~-90 ~
execute if entity @s[y_rotation=180] run tp @e[type=chest_minecart,tag=try_end_box,distance=..0.9,limit=1] ~ ~0.1 ~0.2 ~-90 ~
