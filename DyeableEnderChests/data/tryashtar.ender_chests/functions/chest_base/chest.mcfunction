...
execute if entity @s[tag=try_end_chest] positioned ~ ~-1.2 ~ as @e[type=armor_stand,tag=try_end_ind,distance=..0.7,limit=2] run function tryashtar.ender_chests:chest_base/animate_indicators
