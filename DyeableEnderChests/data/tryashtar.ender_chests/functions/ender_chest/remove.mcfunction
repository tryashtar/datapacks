...
execute positioned ~ ~-1.5 ~ as @e[type=armor_stand,tag=try_end_ind,distance=..0.36,limit=2] run data merge entity @s {Pose:{LeftArm:[0f,0f,120f],RightArm:[0f,0f,-120f]}}
