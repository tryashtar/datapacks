execute if entity @s[nbt={Item:{id:"minecraft:magenta_glazed_terracotta"}}] run scoreboard players set #special try_dis_bid 137
execute if entity @s[nbt={Item:{id:"minecraft:orange_stained_glass_pane"}}] run scoreboard players set #special try_dis_bid 179
execute if entity @s[nbt={Item:{id:"minecraft:purple_stained_glass_pane"}}] run scoreboard players set #special try_dis_bid 182
...
execute if entity @s[nbt={Item:{id:"minecraft:yellow_stained_glass_pane"}}] run scoreboard players set #special try_dis_bid 191
