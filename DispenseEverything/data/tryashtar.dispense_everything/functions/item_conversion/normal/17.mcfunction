...
execute if entity @s[nbt={Item:{id:"minecraft:conduit"}}] store success score #success try_dis_bid run setblock ~ ~ ~ conduit
...
execute if entity @s[nbt={Item:{id:"minecraft:furnace"}}] run scoreboard players set #special try_dis_bid 127
...
execute if entity @s[nbt={Item:{id:"minecraft:lectern"}}] run scoreboard players set #special try_dis_bid 131
