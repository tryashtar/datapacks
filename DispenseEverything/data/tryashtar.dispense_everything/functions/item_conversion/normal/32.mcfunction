execute if entity @s[nbt={Item:{id:"minecraft:blue_glazed_terracotta"}}] run scoreboard players set #special try_dis_bid 141
...
execute if entity @s[nbt={Item:{id:"minecraft:cyan_glazed_terracotta"}}] run scoreboard players set #special try_dis_bid 139
...
execute if entity @s[nbt={Item:{id:"minecraft:gray_glazed_terracotta"}}] run scoreboard players set #special try_dis_bid 137
...
execute if entity @s[nbt={Item:{id:"minecraft:pink_glazed_terracotta"}}] run scoreboard players set #special try_dis_bid 136
...
execute if entity @s[nbt={Item:{id:"minecraft:stripped_dark_oak_wood"}}] run scoreboard players set #special try_dis_bid 24
