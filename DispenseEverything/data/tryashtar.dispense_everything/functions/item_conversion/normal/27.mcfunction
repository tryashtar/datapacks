execute if data storage tryashtar:dispense_everything item{id:"minecraft:acacia_fence_gate"} run scoreboard players set #special try_dis_bid 117
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dark_oak_trapdoor"} run scoreboard players set #special try_dis_bid 254
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dead_bubble_coral"} run scoreboard players set #special try_dis_bid 80
execute if data storage tryashtar:dispense_everything item{id:"minecraft:jungle_fence_gate"} run scoreboard players set #special try_dis_bid 133
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:nether_brick_slab"} run scoreboard players set #special try_dis_bid 224
execute if data storage tryashtar:dispense_everything item{id:"minecraft:nether_brick_wall"} run scoreboard players set #special try_dis_bid 179
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:prismarine_stairs"} run scoreboard players set #special try_dis_bid 271
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:smooth_stone_slab"} run scoreboard players set #special try_dis_bid 240
execute if data storage tryashtar:dispense_everything item{id:"minecraft:spruce_fence_gate"} run scoreboard players set #special try_dis_bid 146
