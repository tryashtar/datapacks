execute if entity @s[nbt={Item:{id:"minecraft:acacia_fence_gate"}}] run setblock ~ ~ ~ acacia_fence_gate
execute if entity @s[nbt={Item:{id:"minecraft:black_shulker_box"}}] run setblock ~ ~ ~ black_shulker_box
execute if entity @s[nbt={Item:{id:"minecraft:brain_coral_block"}}] run setblock ~ ~ ~ brain_coral_block
execute if entity @s[nbt={Item:{id:"minecraft:brown_shulker_box"}}] run setblock ~ ~ ~ brown_shulker_box
...
execute if entity @s[nbt={Item:{id:"minecraft:light_blue_carpet"}}] run setblock ~ ~ ~ light_blue_carpet
execute if entity @s[nbt={Item:{id:"minecraft:light_gray_banner"}}] run setblock ~ ~ ~ light_gray_banner
execute if entity @s[nbt={Item:{id:"minecraft:light_gray_carpet"}}] run setblock ~ ~ ~ light_gray_carpet
...
execute if entity @s[nbt={Item:{id:"minecraft:spruce_fence_gate"}}] run setblock ~ ~ ~ spruce_fence_gate
execute if entity @s[nbt={Item:{id:"minecraft:stripped_oak_wood"}}] run setblock ~ ~ ~ stripped_oak_wood
execute if entity @s[nbt={Item:{id:"minecraft:white_shulker_box"}}] run setblock ~ ~ ~ white_shulker_box
