...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dark_oak_trapdoor"} store success score #success try_dis_bid run setblock ~ ~ ~ dark_oak_trapdoor
