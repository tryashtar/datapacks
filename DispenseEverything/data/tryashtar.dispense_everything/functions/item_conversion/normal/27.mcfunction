...
execute if entity @s[nbt={Item:{id:"minecraft:jungle_fence_gate"}}] run scoreboard players set #special try_dis_bid 130
execute if entity @s[nbt={Item:{id:"minecraft:light_blue_banner"}}] run scoreboard players set #special try_dis_bid 39
execute if entity @s[nbt={Item:{id:"minecraft:light_blue_carpet"}}] unless block ~ ~-1 ~ #tryashtar.dispense_everything:groups/air store success score #success try_dis_bid run setblock ~ ~ ~ light_blue_carpet
execute if entity @s[nbt={Item:{id:"minecraft:light_gray_banner"}}] run scoreboard players set #special try_dis_bid 40
execute if entity @s[nbt={Item:{id:"minecraft:light_gray_carpet"}}] unless block ~ ~-1 ~ #tryashtar.dispense_everything:groups/air store success score #success try_dis_bid run setblock ~ ~ ~ light_gray_carpet
...
execute if entity @s[nbt={Item:{id:"minecraft:nether_brick_wall"}}] store success score #success try_dis_bid run setblock ~ ~ ~ nether_brick_wall
...
execute if entity @s[nbt={Item:{id:"minecraft:spruce_fence_gate"}}] run scoreboard players set #special try_dis_bid 143
