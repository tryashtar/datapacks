...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:jungle_fence_gate"} run scoreboard players set #special try_dis_bid 139
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:spruce_fence_gate"} run scoreboard players set #special try_dis_bid 152
