execute if entity @s[nbt={Item:{id:"minecraft:acacia_fence_gate"}}] run scoreboard players set #special try_dis_bid 123
...
execute if entity @s[nbt={Item:{id:"minecraft:dead_bubble_coral"}}] run scoreboard players set #special try_dis_bid 77
execute if entity @s[nbt={Item:{id:"minecraft:jungle_fence_gate"}}] run scoreboard players set #special try_dis_bid 122
execute if entity @s[nbt={Item:{id:"minecraft:light_blue_banner"}}] run scoreboard players set #special try_dis_bid 32
...
execute if entity @s[nbt={Item:{id:"minecraft:light_gray_banner"}}] run scoreboard players set #special try_dis_bid 37
...
execute if entity @s[nbt={Item:{id:"minecraft:spruce_fence_gate"}}] run scoreboard players set #special try_dis_bid 120
execute if entity @s[nbt={Item:{id:"minecraft:stripped_oak_wood"}}] run scoreboard players set #special try_dis_bid 19
