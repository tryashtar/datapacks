execute if data storage tryashtar:dispense_everything item{id:"minecraft:acacia_fence_gate"} run scoreboard players set #special try_dis_bid 123
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dark_oak_trapdoor"} run scoreboard players set #special try_dis_bid 263
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dead_bubble_coral"} run scoreboard players set #special try_dis_bid 164
execute if data storage tryashtar:dispense_everything item{id:"minecraft:jungle_fence_gate"} run scoreboard players set #special try_dis_bid 141
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:nether_brick_slab"} run scoreboard players set #special try_dis_bid 233
execute if data storage tryashtar:dispense_everything item{id:"minecraft:nether_brick_wall"} run scoreboard players set #special try_dis_bid 197
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:prismarine_stairs"} run scoreboard players set #special try_dis_bid 280
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:smooth_stone_slab"} run scoreboard players set #special try_dis_bid 249
execute if data storage tryashtar:dispense_everything item{id:"minecraft:spruce_fence_gate"} run scoreboard players set #special try_dis_bid 154
