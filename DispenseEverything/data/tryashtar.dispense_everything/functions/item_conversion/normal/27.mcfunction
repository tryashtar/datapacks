...
execute if entity @s[nbt={Item:{id:"minecraft:light_blue_banner"}}] run function tryashtar.dispense_everything:block_check/any/material/solid
...
execute if entity @s[nbt={Item:{id:"minecraft:light_gray_banner"}}] run function tryashtar.dispense_everything:block_check/any/material/solid
