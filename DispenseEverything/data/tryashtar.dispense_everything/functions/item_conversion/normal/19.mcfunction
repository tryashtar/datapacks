...
execute if entity @s[nbt={Item:{id:"minecraft:black_bed"}}] run scoreboard players set #special try_dis_bid 52
...
execute if entity @s[nbt={Item:{id:"minecraft:brown_bed"}}] run scoreboard players set #special try_dis_bid 54
...
execute if entity @s[nbt={Item:{id:"minecraft:green_bed"}}] run scoreboard players set #special try_dis_bid 57
execute if entity @s[nbt={Item:{id:"minecraft:hay_block"}}] run scoreboard players set #special try_dis_bid 26
execute if entity @s[nbt={Item:{id:"minecraft:iron_bars"}}] run setblock ~ ~ ~ iron_bars
execute if entity @s[nbt={Item:{id:"minecraft:iron_door"}}] run scoreboard players set #special try_dis_bid 102
...
execute if entity @s[nbt={Item:{id:"minecraft:rose_bush"}}] run scoreboard players set #special try_dis_bid 111
...
execute if entity @s[nbt={Item:{id:"minecraft:sunflower"}}] run scoreboard players set #special try_dis_bid 109
