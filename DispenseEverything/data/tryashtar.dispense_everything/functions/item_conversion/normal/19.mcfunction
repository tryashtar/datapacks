...
execute if entity @s[nbt={Item:{id:"minecraft:dandelion"}}] if block ~ ~-1 ~ #tryashtar.dispense_everything:groups/plantable run setblock ~ ~ ~ dandelion
...
execute if entity @s[nbt={Item:{id:"minecraft:red_tulip"}}] if block ~ ~-1 ~ #tryashtar.dispense_everything:groups/plantable run setblock ~ ~ ~ red_tulip
