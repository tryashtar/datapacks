...
execute if entity @s[nbt={Item:{id:"minecraft:dandelion"}}] if block ~ ~-1 ~ #tryashtar.dispense_everything:plantable run setblock ~ ~ ~ dandelion
...
execute if entity @s[nbt={Item:{id:"minecraft:red_tulip"}}] if block ~ ~-1 ~ #tryashtar.dispense_everything:plantable run setblock ~ ~ ~ red_tulip
