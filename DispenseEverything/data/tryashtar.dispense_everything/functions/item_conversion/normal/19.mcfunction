...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dispenser"} run scoreboard players set #special try_dis_bid 88
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:iron_bars"} run scoreboard players set #special try_dis_bid 172
execute if data storage tryashtar:dispense_everything item{id:"minecraft:iron_door"} run scoreboard players set #special try_dis_bid 97
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:oak_fence"} run scoreboard players set #special try_dis_bid 182
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:rose_bush"} run scoreboard players set #special try_dis_bid 104
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:sunflower"} run scoreboard players set #special try_dis_bid 105
