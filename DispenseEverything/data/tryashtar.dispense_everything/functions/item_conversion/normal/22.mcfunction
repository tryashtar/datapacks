...
execute if entity @s[nbt={Item:{id:"minecraft:black_banner"}}] run function tryashtar.dispense_everything:block_check/any/material/solid
...
execute if entity @s[nbt={Item:{id:"minecraft:brown_banner"}}] run function tryashtar.dispense_everything:block_check/any/material/solid
...
execute if entity @s[nbt={Item:{id:"minecraft:chorus_plant"}}] run setblock ~ ~ ~ chorus_plant
...
execute if entity @s[nbt={Item:{id:"minecraft:green_banner"}}] run function tryashtar.dispense_everything:block_check/any/material/solid
...
execute if entity @s[nbt={Item:{id:"minecraft:powered_rail"}}] run function tryashtar.dispense_everything:block_check/any/support/tm
...
execute if entity @s[nbt={Item:{id:"minecraft:white_banner"}}] run function tryashtar.dispense_everything:block_check/any/material/solid
