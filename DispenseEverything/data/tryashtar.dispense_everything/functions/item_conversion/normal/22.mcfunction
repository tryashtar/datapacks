...
execute if entity @s[nbt={Item:{id:"minecraft:bubble_coral"}}] run scoreboard players set #special try_dis_bid 38
...
execute if entity @s[nbt={Item:{id:"minecraft:powered_rail"}}] run scoreboard players set #special try_dis_bid 78
...
execute if entity @s[nbt={Item:{id:"minecraft:red_mushroom"}}] run scoreboard players set #special try_dis_bid 66
...
execute if entity @s[nbt={Item:{id:"minecraft:stone_button"}}] run scoreboard players set #special try_dis_bid 24
