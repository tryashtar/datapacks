...
execute if entity @s[nbt={Item:{id:"minecraft:birch_button"}}] run scoreboard players set #special try_dis_bid 71
...
execute if entity @s[nbt={Item:{id:"minecraft:black_banner"}}] run scoreboard players set #special try_dis_bid 44
...
execute if entity @s[nbt={Item:{id:"minecraft:brown_banner"}}] run scoreboard players set #special try_dis_bid 41
...
execute if entity @s[nbt={Item:{id:"minecraft:bubble_coral"}}] run scoreboard players set #special try_dis_bid 82
...
execute if entity @s[nbt={Item:{id:"minecraft:green_banner"}}] run scoreboard players set #special try_dis_bid 42
...
execute if entity @s[nbt={Item:{id:"minecraft:powered_rail"}}] run scoreboard players set #special try_dis_bid 163
...
execute if entity @s[nbt={Item:{id:"minecraft:stone_button"}}] run scoreboard players set #special try_dis_bid 68
execute if entity @s[nbt={Item:{id:"minecraft:stone_stairs"}}] run setblock ~ ~ ~ stone_stairs
execute if entity @s[nbt={Item:{id:"minecraft:white_banner"}}] run scoreboard players set #special try_dis_bid 29
