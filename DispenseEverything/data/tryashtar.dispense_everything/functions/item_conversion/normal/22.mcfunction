execute if entity @s[nbt={Item:{id:"minecraft:acacia_fence"}}] store success score #success try_dis_bid run setblock ~ ~ ~ acacia_fence
...
execute if entity @s[nbt={Item:{id:"minecraft:black_carpet"}}] unless block ~ ~-1 ~ #tryashtar.dispense_everything:groups/air store success score #success try_dis_bid run setblock ~ ~ ~ black_carpet
...
execute if entity @s[nbt={Item:{id:"minecraft:brown_carpet"}}] unless block ~ ~-1 ~ #tryashtar.dispense_everything:groups/air store success score #success try_dis_bid run setblock ~ ~ ~ brown_carpet
...
execute if entity @s[nbt={Item:{id:"minecraft:diorite_wall"}}] store success score #success try_dis_bid run setblock ~ ~ ~ diorite_wall
execute if entity @s[nbt={Item:{id:"minecraft:granite_slab"}}] store success score #success try_dis_bid run setblock ~ ~ ~ granite_slab
execute if entity @s[nbt={Item:{id:"minecraft:granite_wall"}}] store success score #success try_dis_bid run setblock ~ ~ ~ granite_wall
execute if entity @s[nbt={Item:{id:"minecraft:green_banner"}}] run scoreboard players set #special try_dis_bid 37
execute if entity @s[nbt={Item:{id:"minecraft:green_carpet"}}] unless block ~ ~-1 ~ #tryashtar.dispense_everything:groups/air store success score #success try_dis_bid run setblock ~ ~ ~ green_carpet
execute if entity @s[nbt={Item:{id:"minecraft:jungle_fence"}}] store success score #success try_dis_bid run setblock ~ ~ ~ jungle_fence
...
execute if entity @s[nbt={Item:{id:"minecraft:orange_tulip"}}] if block ~ ~-1 ~ #tryashtar.dispense_everything:groups/place_plant store success score #success try_dis_bid run setblock ~ ~ ~ orange_tulip
...
execute if entity @s[nbt={Item:{id:"minecraft:spruce_fence"}}] store success score #success try_dis_bid run setblock ~ ~ ~ spruce_fence
...
execute if entity @s[nbt={Item:{id:"minecraft:white_carpet"}}] unless block ~ ~-1 ~ #tryashtar.dispense_everything:groups/air store success score #success try_dis_bid run setblock ~ ~ ~ white_carpet
