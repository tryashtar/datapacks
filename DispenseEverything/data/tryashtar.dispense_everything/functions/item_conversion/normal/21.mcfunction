execute if entity @s[nbt={Item:{id:"minecraft:acacia_door"}}] run scoreboard players set #special try_dis_bid 56
...
execute if entity @s[nbt={Item:{id:"minecraft:brain_coral"}}] run scoreboard players set #special try_dis_bid 37
...
execute if entity @s[nbt={Item:{id:"minecraft:jungle_door"}}] run scoreboard players set #special try_dis_bid 55
...
execute if entity @s[nbt={Item:{id:"minecraft:spruce_door"}}] run scoreboard players set #special try_dis_bid 53
