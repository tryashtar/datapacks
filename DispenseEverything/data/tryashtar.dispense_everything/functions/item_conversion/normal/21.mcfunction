execute if data storage tryashtar:dispense_everything item{id:"minecraft:acacia_door"} run scoreboard players set #special try_dis_bid 112
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:brain_coral"} run scoreboard players set #special try_dis_bid 162
...
execute if block ~ ~ ~ #tryashtar.dispense_everything:groups/air if block ~ ~-1 ~ #tryashtar.dispense_everything:groups/place_end_crystal if data storage tryashtar:dispense_everything item{id:"minecraft:end_crystal"} align xyz unless entity @e[tag=!try_dis_cur,dx=0,dy=1,dz=0] store success score #success try_dis_bid run summon end_crystal ~0.5 ~ ~0.5 {ShowBottom:0b}
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:jungle_door"} run scoreboard players set #special try_dis_bid 116
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:jungle_slab"} run scoreboard players set #special try_dis_bid 232
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:purpur_slab"} run scoreboard players set #special try_dis_bid 243
execute if data storage tryashtar:dispense_everything item{id:"minecraft:quartz_slab"} run scoreboard players set #special try_dis_bid 244
execute if data storage tryashtar:dispense_everything item{id:"minecraft:scaffolding"} run scoreboard players set #special try_dis_bid 209
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:spruce_door"} run scoreboard players set #special try_dis_bid 118
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:spruce_slab"} run scoreboard players set #special try_dis_bid 252
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:stonecutter"} run scoreboard players set #special try_dis_bid 157
...
execute if block ~ ~1 ~ #tryashtar.dispense_everything:material/merged/replaceable positioned ~ ~-1 ~ if predicate tryashtar.dispense_everything:block_check/up/full positioned ~ ~1 ~ if score #special try_dis_bid matches 112..118 run function tryashtar.dispense_everything:item_conversion/special/shared/door
