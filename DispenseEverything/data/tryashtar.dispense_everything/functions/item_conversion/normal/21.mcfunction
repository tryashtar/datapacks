...
execute if entity @s[nbt={Item:{id:"minecraft:azure_bluet"}}] if block ~ ~-1 ~ #tryashtar.dispense_everything:plantable run setblock ~ ~ ~ azure_bluet
...
execute if entity @s[nbt={Item:{id:"minecraft:blue_orchid"}}] if block ~ ~-1 ~ #tryashtar.dispense_everything:plantable run setblock ~ ~ ~ blue_orchid
...
execute if entity @s[nbt={Item:{id:"minecraft:oak_sapling"}}] if block ~ ~-1 ~ #tryashtar.dispense_everything:plantable run setblock ~ ~ ~ oak_sapling
execute if entity @s[nbt={Item:{id:"minecraft:orange_wool"}}] run setblock ~ ~ ~ orange_wool
execute if entity @s[nbt={Item:{id:"minecraft:oxeye_daisy"}}] if block ~ ~-1 ~ #tryashtar.dispense_everything:plantable run setblock ~ ~ ~ oxeye_daisy
...
execute if entity @s[nbt={Item:{id:"minecraft:white_tulip"}}] if block ~ ~-1 ~ #tryashtar.dispense_everything:plantable run setblock ~ ~ ~ white_tulip
execute if entity @s[nbt={Item:{id:"minecraft:wither_rose"}}] if block ~ ~-1 ~ #tryashtar.dispense_everything:plantable run setblock ~ ~ ~ wither_rose
