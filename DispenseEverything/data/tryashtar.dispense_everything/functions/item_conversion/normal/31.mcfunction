execute if entity @s[nbt={Item:{id:"minecraft:acacia_pressure_plate"}}] run scoreboard players set #special try_dis_bid 192
...
execute if entity @s[nbt={Item:{id:"minecraft:jungle_pressure_plate"}}] run scoreboard players set #special try_dis_bid 196
...
execute if entity @s[nbt={Item:{id:"minecraft:red_glazed_terracotta"}}] run scoreboard players set #special try_dis_bid 142
...
execute if entity @s[nbt={Item:{id:"minecraft:red_nether_brick_wall"}}] run scoreboard players set #special try_dis_bid 183
...
execute if entity @s[nbt={Item:{id:"minecraft:spruce_pressure_plate"}}] run scoreboard players set #special try_dis_bid 199
