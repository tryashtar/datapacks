...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:polished_diorite_slab"} run scoreboard players set #special try_dis_bid 237
execute if data storage tryashtar:dispense_everything item{id:"minecraft:polished_granite_slab"} run scoreboard players set #special try_dis_bid 238
execute if data storage tryashtar:dispense_everything item{id:"minecraft:prismarine_brick_slab"} run scoreboard players set #special try_dis_bid 239
execute if data storage tryashtar:dispense_everything item{id:"minecraft:red_glazed_terracotta"} run scoreboard players set #special try_dis_bid 152
execute if data storage tryashtar:dispense_everything item{id:"minecraft:red_nether_brick_slab"} run scoreboard players set #special try_dis_bid 243
execute if data storage tryashtar:dispense_everything item{id:"minecraft:red_nether_brick_wall"} run scoreboard players set #special try_dis_bid 203
execute if data storage tryashtar:dispense_everything item{id:"minecraft:smooth_sandstone_slab"} run scoreboard players set #special try_dis_bid 248
