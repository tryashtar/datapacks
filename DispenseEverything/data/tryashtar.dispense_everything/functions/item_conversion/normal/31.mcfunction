execute if entity @s[nbt={Item:{id:"minecraft:acacia_pressure_plate"}}] run scoreboard players set #special try_dis_bid 107
...
execute if entity @s[nbt={Item:{id:"minecraft:dead_bubble_coral_fan"}}] run scoreboard players set #special try_dis_bid 59
...
execute if entity @s[nbt={Item:{id:"minecraft:jungle_pressure_plate"}}] run scoreboard players set #special try_dis_bid 106
...
execute if entity @s[nbt={Item:{id:"minecraft:spruce_pressure_plate"}}] run scoreboard players set #special try_dis_bid 104
