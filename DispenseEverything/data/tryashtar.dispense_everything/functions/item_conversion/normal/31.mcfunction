execute if entity @s[nbt={Item:{id:"minecraft:acacia_pressure_plate"}}] run scoreboard players set #special try_dis_bid 158
...
execute if entity @s[nbt={Item:{id:"minecraft:dead_bubble_coral_fan"}}] run scoreboard players set #special try_dis_bid 87
...
execute if entity @s[nbt={Item:{id:"minecraft:jungle_pressure_plate"}}] run scoreboard players set #special try_dis_bid 157
...
execute if entity @s[nbt={Item:{id:"minecraft:red_glazed_terracotta"}}] run scoreboard players set #special try_dis_bid 144
...
execute if entity @s[nbt={Item:{id:"minecraft:spruce_pressure_plate"}}] run scoreboard players set #special try_dis_bid 155
execute if entity @s[nbt={Item:{id:"minecraft:stripped_dark_oak_log"}}] run scoreboard players set #special try_dis_bid 11
