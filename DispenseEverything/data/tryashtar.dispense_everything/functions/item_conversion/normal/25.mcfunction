...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:brain_coral_fan"} run scoreboard players set #special try_dis_bid 77
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dead_fire_coral"} run scoreboard players set #special try_dis_bid 149
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dead_horn_coral"} run scoreboard players set #special try_dis_bid 150
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dead_tube_coral"} run scoreboard players set #special try_dis_bid 151
