execute if data storage tryashtar:dispense_everything item{id:"minecraft:acacia_trapdoor"} run scoreboard players set #special try_dis_bid 247
execute if data storage tryashtar:dispense_everything item{id:"minecraft:andesite_stairs"} run scoreboard players set #special try_dis_bid 248
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dark_oak_stairs"} run scoreboard players set #special try_dis_bid 253
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:jungle_trapdoor"} run scoreboard players set #special try_dis_bid 261
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:prismarine_slab"} run scoreboard players set #special try_dis_bid 231
execute if data storage tryashtar:dispense_everything item{id:"minecraft:prismarine_wall"} run scoreboard players set #special try_dis_bid 183
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:spruce_trapdoor"} run scoreboard players set #special try_dis_bid 281
