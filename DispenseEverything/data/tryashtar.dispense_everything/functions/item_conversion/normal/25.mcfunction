execute if data storage tryashtar:dispense_everything item{id:"minecraft:acacia_trapdoor"} store success score #success try_dis_bid run setblock ~ ~ ~ acacia_trapdoor
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:jungle_trapdoor"} store success score #success try_dis_bid run setblock ~ ~ ~ jungle_trapdoor
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:spruce_trapdoor"} store success score #success try_dis_bid run setblock ~ ~ ~ spruce_trapdoor
