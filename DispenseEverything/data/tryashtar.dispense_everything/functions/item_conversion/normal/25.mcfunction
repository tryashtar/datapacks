execute if data storage tryashtar:dispense_everything item{id:"minecraft:acacia_trapdoor"} run scoreboard players set #special try_dis_bid 258
execute if data storage tryashtar:dispense_everything item{id:"minecraft:andesite_stairs"} run scoreboard players set #special try_dis_bid 259
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dark_oak_stairs"} run scoreboard players set #special try_dis_bid 264
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:jungle_trapdoor"} run scoreboard players set #special try_dis_bid 272
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:spruce_trapdoor"} run scoreboard players set #special try_dis_bid 292
