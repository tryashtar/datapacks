...
execute if entity @s[nbt={Item:{id:"minecraft:dead_fire_coral"}}] run scoreboard players set #special try_dis_bid 34
execute if entity @s[nbt={Item:{id:"minecraft:dead_horn_coral"}}] run scoreboard players set #special try_dis_bid 35
execute if entity @s[nbt={Item:{id:"minecraft:dead_tube_coral"}}] run scoreboard players set #special try_dis_bid 31
