...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:cobblestone_stairs"} run scoreboard players set #special try_dis_bid 252
execute if data storage tryashtar:dispense_everything item{id:"minecraft:cut_sandstone_slab"} run scoreboard players set #special try_dis_bid 215
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:nether_brick_fence"} run scoreboard players set #special try_dis_bid 178
execute if data storage tryashtar:dispense_everything item{id:"minecraft:oak_pressure_plate"} run scoreboard players set #special try_dis_bid 200
execute if data storage tryashtar:dispense_everything item{id:"minecraft:petrified_oak_slab"} run scoreboard players set #special try_dis_bid 226
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:red_sandstone_slab"} run scoreboard players set #special try_dis_bid 235
execute if data storage tryashtar:dispense_everything item{id:"minecraft:red_sandstone_wall"} run scoreboard players set #special try_dis_bid 186
execute if data storage tryashtar:dispense_everything item{id:"minecraft:smooth_quartz_slab"} run scoreboard players set #special try_dis_bid 237
execute if data storage tryashtar:dispense_everything item{id:"minecraft:stone_brick_stairs"} run scoreboard players set #special try_dis_bid 282
