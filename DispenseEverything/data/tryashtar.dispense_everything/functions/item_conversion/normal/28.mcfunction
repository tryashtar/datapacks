...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:cobblestone_stairs"} run scoreboard players set #special try_dis_bid 261
execute if data storage tryashtar:dispense_everything item{id:"minecraft:cut_sandstone_slab"} run scoreboard players set #special try_dis_bid 224
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:nether_brick_fence"} run scoreboard players set #special try_dis_bid 196
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:petrified_oak_slab"} run scoreboard players set #special try_dis_bid 235
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:red_sandstone_slab"} run scoreboard players set #special try_dis_bid 244
execute if data storage tryashtar:dispense_everything item{id:"minecraft:red_sandstone_wall"} run scoreboard players set #special try_dis_bid 204
execute if data storage tryashtar:dispense_everything item{id:"minecraft:smooth_quartz_slab"} run scoreboard players set #special try_dis_bid 246
execute if data storage tryashtar:dispense_everything item{id:"minecraft:stone_brick_stairs"} run scoreboard players set #special try_dis_bid 291
