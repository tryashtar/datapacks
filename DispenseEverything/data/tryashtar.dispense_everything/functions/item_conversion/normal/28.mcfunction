...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:cobblestone_stairs"} run scoreboard players set #special try_dis_bid 245
execute if data storage tryashtar:dispense_everything item{id:"minecraft:cut_sandstone_slab"} run scoreboard players set #special try_dis_bid 208
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:nether_brick_fence"} run scoreboard players set #special try_dis_bid 180
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:petrified_oak_slab"} run scoreboard players set #special try_dis_bid 219
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:red_sandstone_slab"} run scoreboard players set #special try_dis_bid 228
execute if data storage tryashtar:dispense_everything item{id:"minecraft:red_sandstone_wall"} run scoreboard players set #special try_dis_bid 188
execute if data storage tryashtar:dispense_everything item{id:"minecraft:smooth_quartz_slab"} run scoreboard players set #special try_dis_bid 230
execute if data storage tryashtar:dispense_everything item{id:"minecraft:stone_brick_stairs"} run scoreboard players set #special try_dis_bid 275
