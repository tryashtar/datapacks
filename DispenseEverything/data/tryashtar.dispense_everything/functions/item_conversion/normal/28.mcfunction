...
execute if entity @s[nbt={Item:{id:"minecraft:oak_pressure_plate"}}] run function tryashtar.dispense_everything:block_check/any/support/tm_ts
execute if entity @s[nbt={Item:{id:"minecraft:orange_shulker_box"}}] run setblock ~ ~ ~ orange_shulker_box
...
execute if entity @s[nbt={Item:{id:"minecraft:purple_shulker_box"}}] run setblock ~ ~ ~ purple_shulker_box
...
execute if entity @s[nbt={Item:{id:"minecraft:yellow_shulker_box"}}] run setblock ~ ~ ~ yellow_shulker_box
