...
execute if entity @s[nbt={Item:{id:"minecraft:oak_pressure_plate"}}] run scoreboard players set #special try_dis_bid 154
...
execute if entity @s[nbt={Item:{id:"minecraft:stripped_birch_log"}}] run scoreboard players set #special try_dis_bid 8
