...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:barrel"} run scoreboard players set #special try_dis_bid 97
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:ladder"} run scoreboard players set #special try_dis_bid 150
execute if data storage tryashtar:dispense_everything item{id:"minecraft:piston"} run scoreboard players set #special try_dis_bid 102
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:smoker"} run scoreboard players set #special try_dis_bid 145
