...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:barrel"} run scoreboard players set #special try_dis_bid 87
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:ladder"} run scoreboard players set #special try_dis_bid 140
execute if data storage tryashtar:dispense_everything item{id:"minecraft:piston"} run scoreboard players set #special try_dis_bid 92
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:smoker"} run scoreboard players set #special try_dis_bid 135
