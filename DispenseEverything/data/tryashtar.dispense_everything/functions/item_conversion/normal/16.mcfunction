...
execute if entity @s[nbt={Item:{id:"minecraft:ladder"}}] run scoreboard players set #special try_dis_bid 149
...
execute if entity @s[nbt={Item:{id:"minecraft:smoker"}}] run scoreboard players set #special try_dis_bid 118
