...
execute if entity @s[nbt={Item:{id:"minecraft:light_blue_stained_glass_pane"}}] store success score #success try_dis_bid run setblock ~ ~ ~ light_blue_stained_glass_pane
execute if entity @s[nbt={Item:{id:"minecraft:light_gray_stained_glass_pane"}}] store success score #success try_dis_bid run setblock ~ ~ ~ light_gray_stained_glass_pane
