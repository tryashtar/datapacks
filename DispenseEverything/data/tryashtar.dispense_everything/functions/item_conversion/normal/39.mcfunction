execute if entity @s[nbt={Item:{id:"minecraft:heavy_weighted_pressure_plate"}}] run function tryashtar.dispense_everything:block_check/any/support/tm_ts
...
execute if entity @s[nbt={Item:{id:"minecraft:light_weighted_pressure_plate"}}] run function tryashtar.dispense_everything:block_check/any/support/tm_ts
