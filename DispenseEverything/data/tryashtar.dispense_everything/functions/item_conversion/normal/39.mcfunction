execute if entity @s[nbt={Item:{id:"minecraft:heavy_weighted_pressure_plate"}}] run scoreboard players set #special try_dis_bid 92
...
execute if entity @s[nbt={Item:{id:"minecraft:light_weighted_pressure_plate"}}] run scoreboard players set #special try_dis_bid 91
