...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dark_prismarine_slab"} run scoreboard players set #special try_dis_bid 226
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:end_stone_brick_slab"} run scoreboard players set #special try_dis_bid 228
execute if data storage tryashtar:dispense_everything item{id:"minecraft:end_stone_brick_wall"} run scoreboard players set #special try_dis_bid 183
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:red_sandstone_stairs"} run scoreboard players set #special try_dis_bid 284
execute if data storage tryashtar:dispense_everything item{id:"minecraft:smooth_quartz_stairs"} run scoreboard players set #special try_dis_bid 286
