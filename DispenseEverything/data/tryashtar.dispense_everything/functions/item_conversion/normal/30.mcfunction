execute if entity @s[nbt={Item:{id:"minecraft:birch_pressure_plate"}}] run scoreboard players set #special try_dis_bid 193
...
execute if entity @s[nbt={Item:{id:"minecraft:end_stone_brick_wall"}}] run scoreboard players set #special try_dis_bid 163
...
execute if entity @s[nbt={Item:{id:"minecraft:stone_pressure_plate"}}] run scoreboard players set #special try_dis_bid 200
