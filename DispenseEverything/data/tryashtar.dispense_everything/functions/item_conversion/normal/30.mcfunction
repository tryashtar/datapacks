execute if entity @s[nbt={Item:{id:"minecraft:birch_pressure_plate"}}] run scoreboard players set #special try_dis_bid 105
...
execute if entity @s[nbt={Item:{id:"minecraft:stone_pressure_plate"}}] run scoreboard players set #special try_dis_bid 102
