execute if entity @s[nbt={Item:{id:"minecraft:birch_pressure_plate"}}] run scoreboard players set #special try_dis_bid 71
...
execute if entity @s[nbt={Item:{id:"minecraft:dead_brain_coral_fan"}}] run scoreboard players set #special try_dis_bid 42
...
execute if entity @s[nbt={Item:{id:"minecraft:stone_pressure_plate"}}] run scoreboard players set #special try_dis_bid 68
