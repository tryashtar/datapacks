execute if entity @s[nbt={Item:{id:"minecraft:birch_pressure_plate"}}] run scoreboard players set #special try_dis_bid 156
...
execute if entity @s[nbt={Item:{id:"minecraft:dead_brain_coral_fan"}}] run scoreboard players set #special try_dis_bid 86
...
execute if entity @s[nbt={Item:{id:"minecraft:stone_pressure_plate"}}] run scoreboard players set #special try_dis_bid 153
execute if entity @s[nbt={Item:{id:"minecraft:stripped_acacia_wood"}}] run scoreboard players set #special try_dis_bid 23
execute if entity @s[nbt={Item:{id:"minecraft:stripped_jungle_wood"}}] run scoreboard players set #special try_dis_bid 22
execute if entity @s[nbt={Item:{id:"minecraft:stripped_spruce_wood"}}] run scoreboard players set #special try_dis_bid 20
