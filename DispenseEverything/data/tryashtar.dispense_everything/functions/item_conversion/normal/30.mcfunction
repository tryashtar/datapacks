execute if data storage tryashtar:dispense_everything item{id:"minecraft:birch_pressure_plate"} run scoreboard players set #special try_dis_bid 195
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dark_prismarine_slab"} run scoreboard players set #special try_dis_bid 217
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:end_stone_brick_slab"} run scoreboard players set #special try_dis_bid 219
execute if data storage tryashtar:dispense_everything item{id:"minecraft:end_stone_brick_wall"} run scoreboard players set #special try_dis_bid 165
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:red_sandstone_stairs"} run scoreboard players set #special try_dis_bid 275
execute if data storage tryashtar:dispense_everything item{id:"minecraft:smooth_quartz_stairs"} run scoreboard players set #special try_dis_bid 277
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:stone_pressure_plate"} run scoreboard players set #special try_dis_bid 202
