...
execute if entity @s[nbt={Item:{id:"minecraft:activator_rail"}}] run scoreboard players set #special try_dis_bid 165
...
execute if entity @s[nbt={Item:{id:"minecraft:brown_mushroom"}}] run scoreboard players set #special try_dis_bid 152
...
execute if entity @s[nbt={Item:{id:"minecraft:fire_coral_fan"}}] run scoreboard players set #special try_dis_bid 93
...
execute if entity @s[nbt={Item:{id:"minecraft:horn_coral_fan"}}] run scoreboard players set #special try_dis_bid 94
...
execute if entity @s[nbt={Item:{id:"minecraft:light_blue_bed"}}] run scoreboard players set #special try_dis_bid 58
execute if entity @s[nbt={Item:{id:"minecraft:light_gray_bed"}}] run scoreboard players set #special try_dis_bid 59
execute if entity @s[nbt={Item:{id:"minecraft:magenta_banner"}}] run scoreboard players set #special try_dis_bid 31
...
execute if entity @s[nbt={Item:{id:"minecraft:oak_fence_gate"}}] run scoreboard players set #special try_dis_bid 119
...
execute if entity @s[nbt={Item:{id:"minecraft:redstone_torch"}}] run scoreboard players set #special try_dis_bid 169
...
execute if entity @s[nbt={Item:{id:"minecraft:tube_coral_fan"}}] run scoreboard players set #special try_dis_bid 90
...
execute if score #special try_dis_bid matches 151..152 run function tryashtar.dispense_everything:item_conversion/special/shared/mushroom
