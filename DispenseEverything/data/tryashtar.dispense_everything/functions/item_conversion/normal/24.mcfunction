...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:brown_mushroom"} run scoreboard players set #special try_dis_bid 160
...
execute if score #special try_dis_bid matches 160..161 run function tryashtar.dispense_everything:item_conversion/special/shared/mushroom
