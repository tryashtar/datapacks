...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:activator_rail"} run scoreboard players set #special try_dis_bid 212
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:birch_trapdoor"} run scoreboard players set #special try_dis_bid 259
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:brown_mushroom"} run scoreboard players set #special try_dis_bid 158
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dark_oak_fence"} run scoreboard players set #special try_dis_bid 181
execute if data storage tryashtar:dispense_everything item{id:"minecraft:diorite_stairs"} run scoreboard players set #special try_dis_bid 265
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:granite_stairs"} run scoreboard players set #special try_dis_bid 267
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:oak_fence_gate"} run scoreboard players set #special try_dis_bid 146
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:redstone_torch"} run scoreboard players set #special try_dis_bid 253
execute if data storage tryashtar:dispense_everything item{id:"minecraft:sandstone_slab"} run scoreboard players set #special try_dis_bid 245
execute if data storage tryashtar:dispense_everything item{id:"minecraft:sandstone_wall"} run scoreboard players set #special try_dis_bid 206
...
execute if score #special try_dis_bid matches 158..159 run function tryashtar.dispense_everything:item_conversion/special/shared/mushroom
...
execute if score #special try_dis_bid matches 253..254 run function tryashtar.dispense_everything:item_conversion/special/shared/torch
