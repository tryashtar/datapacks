...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:bee_nest"} run scoreboard players set #special try_dis_bid 125
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:campfire"} run scoreboard players set #special try_dis_bid 132
