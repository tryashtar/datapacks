...
execute if entity @s[nbt={Item:{id:"minecraft:blue_bed"}}] run scoreboard players set #special try_dis_bid 53
execute if entity @s[nbt={Item:{id:"minecraft:blue_ice"}}] run setblock ~ ~ ~ blue_ice
execute if entity @s[nbt={Item:{id:"minecraft:campfire"}}] run scoreboard players set #special try_dis_bid 147
...
execute if entity @s[nbt={Item:{id:"minecraft:cyan_bed"}}] run scoreboard players set #special try_dis_bid 55
...
execute if entity @s[nbt={Item:{id:"minecraft:gray_bed"}}] run scoreboard players set #special try_dis_bid 56
...
execute if entity @s[nbt={Item:{id:"minecraft:lime_bed"}}] run scoreboard players set #special try_dis_bid 60
execute if entity @s[nbt={Item:{id:"minecraft:mycelium"}}] run setblock ~ ~ ~ mycelium
execute if entity @s[nbt={Item:{id:"minecraft:oak_door"}}] run scoreboard players set #special try_dis_bid 103
execute if entity @s[nbt={Item:{id:"minecraft:oak_sign"}}] run scoreboard players set #special try_dis_bid 45
execute if entity @s[nbt={Item:{id:"minecraft:oak_slab"}}] run setblock ~ ~ ~ oak_slab
execute if entity @s[nbt={Item:{id:"minecraft:oak_wood"}}] run scoreboard players set #special try_dis_bid 13
...
execute if entity @s[nbt={Item:{id:"minecraft:pink_bed"}}] run scoreboard players set #special try_dis_bid 63
...
execute if entity @s[nbt={Item:{id:"minecraft:repeater"}}] run scoreboard players set #special try_dis_bid 166
