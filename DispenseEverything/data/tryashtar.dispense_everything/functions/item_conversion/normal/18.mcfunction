...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:campfire"} run scoreboard players set #special try_dis_bid 122
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:oak_door"} run scoreboard players set #special try_dis_bid 107
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:oak_slab"} store success score #success try_dis_bid run setblock ~ ~ ~ oak_slab
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:observer"} run scoreboard players set #special try_dis_bid 99
