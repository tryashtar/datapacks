...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:acacia_stairs"} run scoreboard players set #special try_dis_bid 255
execute if data storage tryashtar:dispense_everything item{id:"minecraft:andesite_slab"} run scoreboard players set #special try_dis_bid 219
execute if data storage tryashtar:dispense_everything item{id:"minecraft:andesite_wall"} run scoreboard players set #special try_dis_bid 173
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:blast_furnace"} run scoreboard players set #special try_dis_bid 127
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:chipped_anvil"} run scoreboard players set #special try_dis_bid 131
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:damaged_anvil"} run scoreboard players set #special try_dis_bid 133
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dark_oak_slab"} run scoreboard players set #special try_dis_bid 225
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:detector_rail"} run scoreboard players set #special try_dis_bid 213
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:iron_trapdoor"} run scoreboard players set #special try_dis_bid 268
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:jungle_stairs"} run scoreboard players set #special try_dis_bid 269
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:purpur_stairs"} run scoreboard players set #special try_dis_bid 281
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:quartz_stairs"} run scoreboard players set #special try_dis_bid 282
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:spruce_stairs"} run scoreboard players set #special try_dis_bid 289
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:tripwire_hook"} run scoreboard players set #special try_dis_bid 157
...
execute if score #special try_dis_bid matches 156..157 run function tryashtar.dispense_everything:item_conversion/special/shared/ladder_hook
