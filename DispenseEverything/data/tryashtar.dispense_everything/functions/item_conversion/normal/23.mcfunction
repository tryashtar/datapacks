...
execute if entity @s[nbt={Item:{id:"minecraft:dark_oak_door"}}] run scoreboard players set #special try_dis_bid 73
...
execute if entity @s[nbt={Item:{id:"minecraft:detector_rail"}}] run scoreboard players set #special try_dis_bid 95
...
execute if entity @s[nbt={Item:{id:"minecraft:tripwire_hook"}}] run scoreboard players set #special try_dis_bid 81
