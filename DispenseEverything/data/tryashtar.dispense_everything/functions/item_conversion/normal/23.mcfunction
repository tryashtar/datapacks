...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:acacia_stairs"} run scoreboard players set #special try_dis_bid 246
execute if data storage tryashtar:dispense_everything item{id:"minecraft:andesite_slab"} run scoreboard players set #special try_dis_bid 210
execute if data storage tryashtar:dispense_everything item{id:"minecraft:andesite_wall"} run scoreboard players set #special try_dis_bid 155
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dark_oak_slab"} run scoreboard players set #special try_dis_bid 216
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:detector_rail"} run scoreboard players set #special try_dis_bid 204
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:iron_trapdoor"} run scoreboard players set #special try_dis_bid 259
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:jungle_stairs"} run scoreboard players set #special try_dis_bid 260
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:purpur_stairs"} run scoreboard players set #special try_dis_bid 272
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:quartz_stairs"} run scoreboard players set #special try_dis_bid 273
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:spruce_stairs"} run scoreboard players set #special try_dis_bid 280
