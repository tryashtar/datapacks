...
execute if entity @s[nbt={Item:{id:"minecraft:detector_rail"}}] run setblock ~ ~ ~ detector_rail
...
execute if entity @s[nbt={Item:{id:"minecraft:pumpkin_seeds"}}] run setblock ~ ~ ~ pumpkin_seeds
execute if entity @s[nbt={Item:{id:"minecraft:brewing_stand"}}] run setblock ~ ~ ~ brewing_stand
execute if entity @s[nbt={Item:{id:"minecraft:orange_banner"}}] run setblock ~ ~ ~ orange_banner
execute if entity @s[nbt={Item:{id:"minecraft:yellow_banner"}}] run setblock ~ ~ ~ yellow_banner
execute if entity @s[nbt={Item:{id:"minecraft:purple_banner"}}] run setblock ~ ~ ~ purple_banner
execute if entity @s[nbt={Item:{id:"minecraft:dragon_breath"}}] run setblock ~ ~ ~ dragon_breath
execute if entity @s[nbt={Item:{id:"minecraft:music_disc_13"}}] run setblock ~ ~ ~ music_disc_13
execute if entity @s[nbt={Item:{id:"minecraft:music_disc_11"}}] run setblock ~ ~ ~ music_disc_11
