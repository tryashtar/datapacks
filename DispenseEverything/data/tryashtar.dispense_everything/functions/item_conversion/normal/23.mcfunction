...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:acacia_stairs"} run scoreboard players set #special try_dis_bid 239
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:detector_rail"} run scoreboard players set #special try_dis_bid 197
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:iron_trapdoor"} run scoreboard players set #special try_dis_bid 252
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:jungle_stairs"} run scoreboard players set #special try_dis_bid 253
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:purpur_stairs"} run scoreboard players set #special try_dis_bid 265
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:quartz_stairs"} run scoreboard players set #special try_dis_bid 266
