...
execute if entity @s[nbt={Item:{id:"minecraft:blast_furnace"}}] run function tryashtar.dispense_everything:item_conversion/special/orient/blast_furnace
...
execute if entity @s[nbt={Item:{id:"minecraft:sticky_piston"}}] run function tryashtar.dispense_everything:item_conversion/special/orient/sticky_piston
