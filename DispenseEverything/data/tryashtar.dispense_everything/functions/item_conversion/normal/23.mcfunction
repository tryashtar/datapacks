...
execute if entity @s[nbt={Item:{id:"minecraft:dark_oak_sign"}}] run function tryashtar.dispense_everything:block_check/any/material/solid
...
execute if entity @s[nbt={Item:{id:"minecraft:sweet_berries"}}] run setblock ~ ~ ~ sweet_berry_bush
execute if entity @s[nbt={Item:{id:"minecraft:trapped_chest"}}] run setblock ~ ~ ~ trapped_chest
execute if entity @s[nbt={Item:{id:"minecraft:tripwire_hook"}}] run say [NYI]
