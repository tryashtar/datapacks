execute if data storage tryashtar:dispense_everything item{id:"minecraft:anvil"} run scoreboard players set #special try_dis_bid 108
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:lilac"} run scoreboard players set #special try_dis_bid 102
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:peony"} run scoreboard players set #special try_dis_bid 103
