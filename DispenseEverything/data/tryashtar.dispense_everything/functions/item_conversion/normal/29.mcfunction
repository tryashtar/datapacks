...
execute if entity @s[nbt={Item:{id:"minecraft:dead_fire_coral_fan"}}] run setblock ~ ~ ~ dead_fire_coral_fan
execute if entity @s[nbt={Item:{id:"minecraft:dead_horn_coral_fan"}}] run setblock ~ ~ ~ dead_horn_coral_fan
execute if entity @s[nbt={Item:{id:"minecraft:dead_tube_coral_fan"}}] run setblock ~ ~ ~ dead_tube_coral_fan
...
execute if entity @s[nbt={Item:{id:"minecraft:magenta_shulker_box"}}] run setblock ~ ~ ~ magenta_shulker_box
