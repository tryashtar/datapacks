...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dark_oak_fence_gate"} run scoreboard players set #special try_dis_bid 118
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dead_fire_coral_fan"} run scoreboard players set #special try_dis_bid 81
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dead_horn_coral_fan"} run scoreboard players set #special try_dis_bid 82
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dead_tube_coral_fan"} run scoreboard players set #special try_dis_bid 83
