...
execute if entity @s[nbt={Item:{id:"minecraft:cobblestone_wall"}}] run scoreboard players set #special try_dis_bid 159
execute if block ~ ~-1 ~ #tryashtar.dispense_everything:groups/place_plant if entity @s[nbt={Item:{id:"minecraft:dark_oak_sapling"}}] store success score #success try_dis_bid run setblock ~ ~ ~ dark_oak_sapling
...
execute if entity @s[nbt={Item:{id:"minecraft:end_portal_frame"}}] run scoreboard players set #special try_dis_bid 127
...
execute if entity @s[nbt={Item:{id:"minecraft:stone_brick_wall"}}] run scoreboard players set #special try_dis_bid 189
