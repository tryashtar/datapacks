execute if data storage tryashtar:dispense_everything item{id:"minecraft:birch_fence_gate"} run scoreboard players set #special try_dis_bid 119
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:bubble_coral_fan"} run scoreboard players set #special try_dis_bid 88
execute if data storage tryashtar:dispense_everything item{id:"minecraft:cobblestone_slab"} run scoreboard players set #special try_dis_bid 213
execute if data storage tryashtar:dispense_everything item{id:"minecraft:cobblestone_wall"} run scoreboard players set #special try_dis_bid 161
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dead_brain_coral"} run scoreboard players set #special try_dis_bid 79
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:end_portal_frame"} run scoreboard players set #special try_dis_bid 129
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:sandstone_stairs"} run scoreboard players set #special try_dis_bid 276
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:stone_brick_slab"} run scoreboard players set #special try_dis_bid 242
execute if data storage tryashtar:dispense_everything item{id:"minecraft:stone_brick_wall"} run scoreboard players set #special try_dis_bid 191
