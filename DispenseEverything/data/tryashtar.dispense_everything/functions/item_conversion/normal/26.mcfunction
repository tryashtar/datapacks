execute if entity @s[nbt={Item:{id:"minecraft:birch_fence_gate"}}] run scoreboard players set #special try_dis_bid 121
...
execute if entity @s[nbt={Item:{id:"minecraft:bubble_coral_fan"}}] run scoreboard players set #special try_dis_bid 92
...
execute if entity @s[nbt={Item:{id:"minecraft:dead_brain_coral"}}] run scoreboard players set #special try_dis_bid 76
...
execute if entity @s[nbt={Item:{id:"minecraft:end_portal_frame"}}] run scoreboard players set #special try_dis_bid 125
...
execute if entity @s[nbt={Item:{id:"minecraft:stripped_oak_log"}}] run scoreboard players set #special try_dis_bid 12
