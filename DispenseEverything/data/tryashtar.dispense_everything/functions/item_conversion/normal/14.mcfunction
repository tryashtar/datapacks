...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:loom"} run scoreboard players set #special try_dis_bid 128
execute if data storage tryashtar:dispense_everything item{id:"minecraft:rail"} run scoreboard players set #special try_dis_bid 199
