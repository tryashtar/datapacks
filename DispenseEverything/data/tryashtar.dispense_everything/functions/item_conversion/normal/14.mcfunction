...
execute unless block ~ ~-1 ~ magma_block if entity @s[tag=try_dis_wtrc] if data storage tryashtar:dispense_everything item{id:"minecraft:kelp"} run function tryashtar.dispense_everything:item_conversion/special/kelp
