...
execute if entity @s[nbt={Item:{id:"minecraft:loom"}}] run scoreboard players set #special try_dis_bid 148
execute if entity @s[nbt={Item:{id:"minecraft:rail"}}] run scoreboard players set #special try_dis_bid 162
