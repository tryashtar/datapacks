...
execute if score #special try_dis_bid matches 110..111 run function tryashtar.dispense_everything:item_conversion/special/shared/dirtlike
...
execute if score #special try_dis_bid matches 119..124 if block ~ ~-1 ~ #tryashtar.dispense_everything:groups/place_plant if block ~ ~1 ~ #tryashtar.dispense_everything:material/merged/replaceable run function tryashtar.dispense_everything:item_conversion/special/shared/double_plant
