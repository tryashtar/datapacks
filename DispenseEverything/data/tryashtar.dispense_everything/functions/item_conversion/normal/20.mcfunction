execute if entity @s[nbt={Item:{id:"minecraft:acacia_log"}}] run scoreboard players set #special try_dis_bid 5
execute if entity @s[nbt={Item:{id:"minecraft:birch_door"}}] run scoreboard players set #special try_dis_bid 105
execute if entity @s[nbt={Item:{id:"minecraft:birch_sign"}}] run scoreboard players set #special try_dis_bid 47
execute if entity @s[nbt={Item:{id:"minecraft:birch_slab"}}] run setblock ~ ~ ~ birch_slab
execute if entity @s[nbt={Item:{id:"minecraft:birch_wood"}}] run scoreboard players set #special try_dis_bid 15
execute if entity @s[nbt={Item:{id:"minecraft:black_wool"}}] run setblock ~ ~ ~ black_wool
execute if entity @s[nbt={Item:{id:"minecraft:bone_block"}}] run scoreboard players set #special try_dis_bid 28
...
execute if entity @s[nbt={Item:{id:"minecraft:comparator"}}] run scoreboard players set #special try_dis_bid 167
...
execute if entity @s[nbt={Item:{id:"minecraft:fire_coral"}}] run scoreboard players set #special try_dis_bid 83
...
execute if entity @s[nbt={Item:{id:"minecraft:horn_coral"}}] run scoreboard players set #special try_dis_bid 84
...
execute if entity @s[nbt={Item:{id:"minecraft:jungle_log"}}] run scoreboard players set #special try_dis_bid 4
execute if entity @s[nbt={Item:{id:"minecraft:large_fern"}}] run scoreboard players set #special try_dis_bid 114
...
execute if entity @s[nbt={Item:{id:"minecraft:oak_button"}}] run scoreboard players set #special try_dis_bid 69
...
execute if entity @s[nbt={Item:{id:"minecraft:orange_bed"}}] run scoreboard players set #special try_dis_bid 62
...
execute if entity @s[nbt={Item:{id:"minecraft:purple_bed"}}] run scoreboard players set #special try_dis_bid 64
execute if entity @s[nbt={Item:{id:"minecraft:red_banner"}}] run scoreboard players set #special try_dis_bid 43
...
execute if entity @s[nbt={Item:{id:"minecraft:spruce_log"}}] run scoreboard players set #special try_dis_bid 2
...
execute if entity @s[nbt={Item:{id:"minecraft:tall_grass"}}] run scoreboard players set #special try_dis_bid 113
execute if entity @s[nbt={Item:{id:"minecraft:terracotta"}}] run setblock ~ ~ ~ terracotta
execute if entity @s[nbt={Item:{id:"minecraft:tube_coral"}}] run scoreboard players set #special try_dis_bid 80
...
execute if score #special try_dis_bid matches 113..114 run function tryashtar.dispense_everything:item_conversion/special/shared/double_replaceable
execute if score #special try_dis_bid matches 166..167 run function tryashtar.dispense_everything:item_conversion/special/shared/redstone_gate
