...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:birch_door"} run scoreboard players set #special try_dis_bid 95
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:birch_slab"} run scoreboard players set #special try_dis_bid 204
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:brick_slab"} run scoreboard players set #special try_dis_bid 205
execute if data storage tryashtar:dispense_everything item{id:"minecraft:brick_wall"} run scoreboard players set #special try_dis_bid 161
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:comparator"} run scoreboard players set #special try_dis_bid 200
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:fire_coral"} run scoreboard players set #special try_dis_bid 152
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:glass_pane"} run scoreboard players set #special try_dis_bid 168
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:horn_coral"} run scoreboard players set #special try_dis_bid 153
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:large_fern"} run scoreboard players set #special try_dis_bid 101
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:oak_stairs"} run scoreboard players set #special try_dis_bid 258
...
execute positioned ~ ~-1 ~ if predicate tryashtar.dispense_everything:block_check/up/any positioned ~ ~1 ~ if data storage tryashtar:dispense_everything item{id:"minecraft:sea_pickle"} run scoreboard players set #special try_dis_bid 154
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:stone_slab"} run scoreboard players set #special try_dis_bid 236
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:tall_grass"} run scoreboard players set #special try_dis_bid 106
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:tube_coral"} run scoreboard players set #special try_dis_bid 155
...
execute if score #special try_dis_bid matches 101..106 if block ~ ~-1 ~ #tryashtar.dispense_everything:groups/place_plant if block ~ ~1 ~ #tryashtar.dispense_everything:material/merged/replaceable run function tryashtar.dispense_everything:item_conversion/special/shared/double_plant
...
execute positioned ~ ~-1 ~ if predicate tryashtar.dispense_everything:block_check/up/rim positioned ~ ~1 ~ if score #special try_dis_bid matches 200..201 run function tryashtar.dispense_everything:item_conversion/special/shared/horizontal
