...
execute if entity @s[nbt={Item:{id:"minecraft:birch_sign"}}] run setblock ~ ~ ~ birch_sign
...
execute if entity @s[nbt={Item:{id:"minecraft:cornflower"}}] if block ~ ~-1 ~ #tryashtar.dispense_everything:plantable run setblock ~ ~ ~ cornflower
...
execute if entity @s[nbt={Item:{id:"minecraft:pink_tulip"}}] if block ~ ~-1 ~ #tryashtar.dispense_everything:plantable run setblock ~ ~ ~ pink_tulip
...
execute if entity @s[nbt={Item:{id:"minecraft:sea_pickle"}}] run setblock ~ ~ ~ sea_pickle
...
execute if entity @s[nbt={Item:{id:"minecraft:sugar_cane"}}] run setblock ~ ~ ~ sugar_cane
