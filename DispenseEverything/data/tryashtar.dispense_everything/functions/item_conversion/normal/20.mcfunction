...
execute if entity @s[nbt={Item:{id:"minecraft:brick_wall"}}] run scoreboard players set #special try_dis_bid 157
...
execute if entity @s[nbt={Item:{id:"minecraft:comparator"}}] run scoreboard players set #special try_dis_bid 205
execute if block ~ ~-1 ~ #tryashtar.dispense_everything:groups/place_plant if entity @s[nbt={Item:{id:"minecraft:cornflower"}}] store success score #success try_dis_bid run setblock ~ ~ ~ cornflower
...
execute if entity @s[nbt={Item:{id:"minecraft:glass_pane"}}] run scoreboard players set #special try_dis_bid 164
...
execute if block ~ ~-1 ~ #tryashtar.dispense_everything:groups/place_plant if entity @s[nbt={Item:{id:"minecraft:pink_tulip"}}] store success score #success try_dis_bid run setblock ~ ~ ~ pink_tulip
...
execute unless block ~ ~-1 ~ #tryashtar.dispense_everything:groups/air if entity @s[nbt={Item:{id:"minecraft:red_carpet"}}] store success score #success try_dis_bid run setblock ~ ~ ~ red_carpet
