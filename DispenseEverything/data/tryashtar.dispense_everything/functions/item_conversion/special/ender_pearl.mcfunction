...
execute if score #firstdir try_dis_bid matches 1 run summon ender_pearl ~ ~ ~ {Passengers:[{id:area_effect_cloud,CustomName:'{"translate":"item.minecraft.ender_pearl"}',Tags:["try_dis_endn","try_dis_end"],Duration:400}],Motion:[-1.1d,0.1d,0d],Tags:["try_dis_end"]}
execute if score #firstdir try_dis_bid matches 2 run summon ender_pearl ~ ~ ~ {Passengers:[{id:area_effect_cloud,CustomName:'{"translate":"item.minecraft.ender_pearl"}',Tags:["try_dis_endn","try_dis_end"],Duration:400}],Motion:[1.1d,0.1d,0d],Tags:["try_dis_end"]}
execute if score #firstdir try_dis_bid matches 3 run summon ender_pearl ~ ~ ~ {Passengers:[{id:area_effect_cloud,CustomName:'{"translate":"item.minecraft.ender_pearl"}',Tags:["try_dis_endn","try_dis_end"],Duration:400}],Motion:[0d,-1d,0d],Tags:["try_dis_end"]}
execute if score #firstdir try_dis_bid matches 4 run summon ender_pearl ~ ~ ~ {Passengers:[{id:area_effect_cloud,CustomName:'{"translate":"item.minecraft.ender_pearl"}',Tags:["try_dis_endn","try_dis_end"],Duration:400}],Motion:[0d,1.2d,0d],Tags:["try_dis_end"]}
execute if score #firstdir try_dis_bid matches 5 run summon ender_pearl ~ ~ ~ {Passengers:[{id:area_effect_cloud,CustomName:'{"translate":"item.minecraft.ender_pearl"}',Tags:["try_dis_endn","try_dis_end"],Duration:400}],Motion:[0d,0.1d,-1.1d],Tags:["try_dis_end"]}
execute if score #firstdir try_dis_bid matches 6 run summon ender_pearl ~ ~ ~ {Passengers:[{id:area_effect_cloud,CustomName:'{"translate":"item.minecraft.ender_pearl"}',Tags:["try_dis_endn","try_dis_end"],Duration:400}],Motion:[0d,0.1d,1.1d],Tags:["try_dis_end"]}
