...
execute unless block ~ ~ ~ chorus_plant if entity @s[tag=!try_dis_vtc] if block ~ ~-1 ~ #tryashtar.dispense_everything:groups/place_chorus run setblock ~ ~ ~ chorus_plant

execute unless block ~ ~ ~ chorus_plant if entity @s[tag=!try_dis_vtc] if block ~1 ~ ~ chorus_plant if block ~1 ~-1 ~ #tryashtar.dispense_everything:groups/place_chorus run setblock ~ ~ ~ chorus_plant
execute unless block ~ ~ ~ chorus_plant if entity @s[tag=!try_dis_vtc] if block ~-1 ~ ~ chorus_plant if block ~-1 ~-1 ~ #tryashtar.dispense_everything:groups/place_chorus run setblock ~ ~ ~ chorus_plant
execute unless block ~ ~ ~ chorus_plant if entity @s[tag=!try_dis_vtc] if block ~ ~ ~1 chorus_plant if block ~ ~-1 ~1 #tryashtar.dispense_everything:groups/place_chorus run setblock ~ ~ ~ chorus_plant
execute unless block ~ ~ ~ chorus_plant if entity @s[tag=!try_dis_vtc] if block ~ ~ ~-1 chorus_plant if block ~ ~-1 ~-1 #tryashtar.dispense_everything:groups/place_chorus run setblock ~ ~ ~ chorus_plant
