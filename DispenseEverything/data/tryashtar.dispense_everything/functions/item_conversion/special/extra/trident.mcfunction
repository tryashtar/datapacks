...
execute if data storage tryashtar:dispense_everything item.tag.Enchantments[{id:"minecraft:loyalty"}] run function tryashtar.dispense_everything:item_conversion/special/extra/trident_loyalty
