...
execute if block ~ ~ ~ #minecraft:beehives unless data storage tryashtar:dispense_everything item.tag.Enchantments[{id:"minecraft:silk_touch"}] align xyz positioned ~0.5 ~0.5 ~0.5 run function tryashtar.dispense_everything:item_conversion/special/extra/spawn_bees
