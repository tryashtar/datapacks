...
execute unless block ~ ~ ~ vine[south=true] if entity @s[tag=!try_dis_ok] positioned ~ ~ ~1 run function tryashtar.dispense_everything:block_check/support/north_full
execute if entity @s[tag=try_dis_ok] run function tryashtar.dispense_everything:item_conversion/special/merge/vine/place/south
...
# back (dispenser)
execute unless block ~ ~ ~ vine[north=true] if entity @s[tag=!try_dis_don] run function tryashtar.dispense_everything:item_conversion/special/merge/vine/place/north
