...
execute unless block ~ ~ ~ vine[east=true] if entity @s[tag=!try_dis_ok] positioned ~1 ~ ~ run function tryashtar.dispense_everything:block_check/support/west_full
execute if entity @s[tag=try_dis_ok] run function tryashtar.dispense_everything:item_conversion/special/merge/vine/place/east
...
# back (dispenser)
execute unless block ~ ~ ~ vine[west=true] if entity @s[tag=!try_dis_don] run function tryashtar.dispense_everything:item_conversion/special/merge/vine/place/west
