...
execute unless block ~ ~-1 ~ hay_block unless predicate tryashtar.dispense_everything:waterlog if score #special try_dis_bid matches 122 run setblock ~ ~ ~ campfire[facing=north]
execute if block ~ ~-1 ~ hay_block unless predicate tryashtar.dispense_everything:waterlog if score #special try_dis_bid matches 122 run setblock ~ ~ ~ campfire[facing=north,signal_fire=true]
execute if predicate tryashtar.dispense_everything:waterlog if score #special try_dis_bid matches 122 run setblock ~ ~ ~ campfire[facing=north,waterlogged=true,lit=false]
