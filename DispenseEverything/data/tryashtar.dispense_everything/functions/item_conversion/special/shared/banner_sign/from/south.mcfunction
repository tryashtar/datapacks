...
execute if entity @s[tag=!try_dis_ok] if block ~ ~-1 ~ #tryashtar.dispense_everything:material/merged/solid run function tryashtar.dispense_everything:item_conversion/special/shared/banner_sign/place/down/south
