...
execute if block ~ ~ ~ #tryashtar.dispense_everything:support/up_center_3[facing=up] run tag @s add try_dis_ok
execute if block ~ ~ ~ #tryashtar.dispense_everything:support/up_center_2[facing=down] run tag @s add try_dis_ok
execute if block ~ ~ ~ #minecraft:fence_gates[open=false] run tag @s add try_dis_ok
...
execute if block ~ ~ ~ #tryashtar.dispense_everything:support/up_center_4[up=true] run tag @s add try_dis_ok
...
execute if block ~ ~ ~ #tryashtar.dispense_everything:support/up_center_1 run tag @s add try_dis_ok
