...
execute if block ~ ~ ~ chorus_plant[down=false,east=false,north=false,south=false,up=true,west=true] run tag @s add try_dis_ok
execute if block ~ ~ ~ chorus_plant[down=false,east=true,north=false,south=false,up=true,west=true] run tag @s add try_dis_ok
execute if block ~ ~ ~ chorus_plant[down=false,east=false,north=false,south=true,up=true,west=false] run tag @s add try_dis_ok
execute if block ~ ~ ~ chorus_plant[down=false,east=true,north=false,south=true,up=true,west=false] run tag @s add try_dis_ok
execute if block ~ ~ ~ chorus_plant[down=false,east=false,north=false,south=true,up=true,west=true] run tag @s add try_dis_ok
...
execute if entity @s[tag=!try_dis_ok] run function tryashtar.dispense_everything:block_properties/fftfftffffffffff
...
execute if entity @s[tag=!try_dis_ok] run function tryashtar.dispense_everything:block_properties/fftffttfffffffff
execute if entity @s[tag=!try_dis_ok] run function tryashtar.dispense_everything:block_properties/ffttftffffffffff
...
execute if entity @s[tag=!try_dis_ok] run function tryashtar.dispense_everything:block_properties/ffttfttffftfffff
...
execute if entity @s[tag=!try_dis_ok] run function tryashtar.dispense_everything:block_properties/fffffttfffffffff
execute if entity @s[tag=!try_dis_ok] run function tryashtar.dispense_everything:block_properties/ffttfttfffffffff
