execute if block ~ ~ ~ chorus_plant[down=false,east=true,north=false,south=true,up=false,west=false] run tag @s add try_dis_ok
execute if block ~ ~ ~ chorus_plant[down=false,east=true,north=false,south=true,up=false,west=true] run tag @s add try_dis_ok
...
execute if block ~ ~ ~ chorus_plant[down=false,east=true,north=false,south=false,up=true,west=false] run tag @s add try_dis_ok
execute if block ~ ~ ~ chorus_plant[down=false,east=true,north=false,south=false,up=true,west=true] run tag @s add try_dis_ok
execute if block ~ ~ ~ chorus_plant[down=false,east=true,north=false,south=true,up=true,west=false] run tag @s add try_dis_ok
execute if block ~ ~ ~ chorus_plant[down=false,east=true,north=false,south=true,up=true,west=true] run tag @s add try_dis_ok
...
execute if block ~ ~ ~ chorus_plant[down=true,east=true,north=false,south=false,up=false,west=true] run tag @s add try_dis_ok
execute if block ~ ~ ~ chorus_plant[down=true,east=true,north=false,south=true,up=false,west=false] run tag @s add try_dis_ok
execute if block ~ ~ ~ chorus_plant[down=true,east=true,north=false,south=true,up=false,west=true] run tag @s add try_dis_ok
...
execute if entity @s[tag=!try_dis_ok] run function tryashtar.dispense_everything:block_properties/fffffffffffffftf
execute if entity @s[tag=!try_dis_ok] run function tryashtar.dispense_everything:block_properties/ffttfffffffffftf
execute if entity @s[tag=!try_dis_ok] run function tryashtar.dispense_everything:block_properties/ffttfttffffffftf
execute if entity @s[tag=!try_dis_ok] run function tryashtar.dispense_everything:block_properties/ffttfttffftffftf
