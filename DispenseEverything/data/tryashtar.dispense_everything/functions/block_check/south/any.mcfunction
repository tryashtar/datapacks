execute if block ~ ~ ~ chorus_plant[south=true] run tag @s add try_dis_ok
...
execute if entity @s[tag=!try_dis_ok] run function tryashtar.dispense_everything:block_properties/fffffffffftfffff
