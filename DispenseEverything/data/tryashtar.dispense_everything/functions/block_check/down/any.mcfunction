...
execute if block ~ ~ ~ chorus_plant[down=true,east=false,north=false,south=true,up=false,west=true] run tag @s add try_dis_ok
...
execute if entity @s[tag=!try_dis_ok] run function tryashtar.dispense_everything:block_properties/fftfffffffffffff
...
execute if entity @s[tag=!try_dis_ok] run function tryashtar.dispense_everything:block_properties/ffttfffffftfffff
...
execute if entity @s[tag=!try_dis_ok] run function tryashtar.dispense_everything:block_properties/ffttffffffffffff
