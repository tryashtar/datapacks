...
# cheap check to determine if this is likely fired from a dispenser
...
execute if score @s try_dis_dir matches 1.. run function tryashtar.dispense_everything:near_dispenser
