...
execute if block ~ ~ ~ #tryashtar.dispense_everything:groups/tillable as 0-1c9-c369-0-2678 if predicate tryashtar.dispense_everything:item/hoe run function tryashtar.dispense_everything:behavior/special/extra/hoe
execute if block ~ ~ ~ #tryashtar.dispense_everything:tool/shovel as 0-1c9-c369-0-2678 if predicate tryashtar.dispense_everything:item/shovel run function tryashtar.dispense_everything:behavior/special/extra/mine
execute if block ~ ~ ~ #tryashtar.dispense_everything:tool/axe as 0-1c9-c369-0-2678 if predicate tryashtar.dispense_everything:item/axe run function tryashtar.dispense_everything:behavior/special/extra/mine
...
execute as 0-1c9-c369-0-2678 if predicate tryashtar.dispense_everything:item/horse_armor as @e[type=horse,predicate=!tryashtar.dispense_everything:baby,dy=0,nbt={Tame:1b},nbt=!{ArmorItem:{}},sort=nearest,limit=1] run function tryashtar.dispense_everything:behavior/special/extra/horse_armor
...
execute as 0-1c9-c369-0-2678 if predicate tryashtar.dispense_everything:item/carpet as @e[type=#tryashtar.dispense_everything:llama,predicate=!tryashtar.dispense_everything:baby,dy=0,nbt={Tame:1b},nbt=!{DecorItem:{}},sort=nearest,limit=1] at @s run function tryashtar.dispense_everything:behavior/special/extra/carpet
...
execute as 0-1c9-c369-0-2678 if predicate tryashtar.dispense_everything:item/dye as @e[type=#tryashtar.dispense_everything:collared,nbt=!{OwnerUUID:""},sort=nearest,limit=1] run function tryashtar.dispense_everything:behavior/special/extra/dye_collar
