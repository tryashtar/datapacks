...
execute as 0-1c9-c369-0-2678 if predicate tryashtar.dispense_everything:item/seeds align xyz as @e[type=chicken,dy=0,nbt={InLove:0},sort=nearest,limit=1] at @s run function tryashtar.dispense_everything:behavior/special/extra/feed_animal
execute if data storage tryashtar:dispense_everything item{id:"minecraft:wheat"} align xyz as @e[type=#tryashtar.dispense_everything:likes_wheat,dy=0,nbt={InLove:0},sort=nearest,limit=1] at @s run function tryashtar.dispense_everything:behavior/special/extra/feed_animal
execute if data storage tryashtar:dispense_everything item{id:"minecraft:sweet_berries"} align xyz as @e[type=fox,dy=0,nbt={InLove:0},sort=nearest,limit=1] at @s run function tryashtar.dispense_everything:behavior/special/extra/feed_animal
execute as 0-1c9-c369-0-2678 if predicate tryashtar.dispense_everything:item/fish align xyz as @e[type=ocelot,dy=0,nbt={InLove:0},sort=nearest,limit=1] at @s run function tryashtar.dispense_everything:behavior/special/extra/feed_animal
execute if data storage tryashtar:dispense_everything item{id:"minecraft:bamboo"} align xyz as @e[type=panda,dy=0,nbt={InLove:0},sort=nearest,limit=1] at @s run function tryashtar.dispense_everything:behavior/special/extra/feed_animal
execute as 0-1c9-c369-0-2678 if predicate tryashtar.dispense_everything:item/pig_food align xyz as @e[type=pig,dy=0,nbt={InLove:0},sort=nearest,limit=1] at @s run function tryashtar.dispense_everything:behavior/special/extra/feed_animal
execute as 0-1c9-c369-0-2678 if predicate tryashtar.dispense_everything:item/rabbit_food align xyz as @e[type=rabbit,dy=0,nbt={InLove:0},sort=nearest,limit=1] at @s run function tryashtar.dispense_everything:behavior/special/extra/feed_animal
execute as 0-1c9-c369-0-2678 if predicate tryashtar.dispense_everything:item/flower align xyz as @e[type=bee,dy=0,nbt={InLove:0},sort=nearest,limit=1] at @s run function tryashtar.dispense_everything:behavior/special/extra/feed_animal
execute if data storage tryashtar:dispense_everything item{id:"minecraft:seagrass"} align xyz as @e[type=turtle,dy=0,nbt={HasEgg:0b,InLove:0},sort=nearest,limit=1] at @s run function tryashtar.dispense_everything:behavior/special/extra/feed_animal
