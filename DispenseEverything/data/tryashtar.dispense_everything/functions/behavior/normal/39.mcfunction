...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:light_blue_stained_glass_pane"} run scoreboard players set #special try_dis_bid 192
execute if data storage tryashtar:dispense_everything item{id:"minecraft:light_gray_stained_glass_pane"} run scoreboard players set #special try_dis_bid 193
