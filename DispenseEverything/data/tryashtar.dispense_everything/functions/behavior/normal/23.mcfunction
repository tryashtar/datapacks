...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:blast_furnace"} run scoreboard players set #special try_dis_bid 131
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:chipped_anvil"} run scoreboard players set #special try_dis_bid 135
execute if data storage tryashtar:dispense_everything item{id:"minecraft:chorus_flower"} run function tryashtar.dispense_everything:behavior/special/chorus_flower
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:damaged_anvil"} run scoreboard players set #special try_dis_bid 137
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dark_oak_door"} run scoreboard players set #special try_dis_bid 114
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:iron_trapdoor"} run scoreboard players set #special try_dis_bid 291
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:jungle_stairs"} run scoreboard players set #special try_dis_bid 265
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:purpur_stairs"} run scoreboard players set #special try_dis_bid 275
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:quartz_stairs"} run scoreboard players set #special try_dis_bid 276
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:redstone_lamp"} run function tryashtar.dispense_everything:behavior/special/redstone_lamp
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:spruce_stairs"} run scoreboard players set #special try_dis_bid 283
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:tripwire_hook"} run scoreboard players set #special try_dis_bid 161
...
execute if score #special try_dis_bid matches 160..161 run function tryashtar.dispense_everything:behavior/special/shared/ladder_hook
