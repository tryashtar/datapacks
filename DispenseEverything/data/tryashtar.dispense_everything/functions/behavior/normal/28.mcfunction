...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:cobblestone_stairs"} run scoreboard players set #special try_dis_bid 259
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:stone_brick_stairs"} run scoreboard players set #special try_dis_bid 284
