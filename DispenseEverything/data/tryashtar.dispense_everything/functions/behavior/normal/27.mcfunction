...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:dark_oak_trapdoor"} run scoreboard players set #special try_dis_bid 290
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:prismarine_stairs"} run scoreboard players set #special try_dis_bid 274
