...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:polished_diorite_stairs"} run scoreboard players set #special try_dis_bid 271
execute if data storage tryashtar:dispense_everything item{id:"minecraft:polished_granite_stairs"} run scoreboard players set #special try_dis_bid 272
execute if data storage tryashtar:dispense_everything item{id:"minecraft:prismarine_brick_stairs"} run scoreboard players set #special try_dis_bid 273
execute if data storage tryashtar:dispense_everything item{id:"minecraft:red_nether_brick_stairs"} run scoreboard players set #special try_dis_bid 277
execute if data storage tryashtar:dispense_everything item{id:"minecraft:smooth_sandstone_stairs"} run scoreboard players set #special try_dis_bid 282
