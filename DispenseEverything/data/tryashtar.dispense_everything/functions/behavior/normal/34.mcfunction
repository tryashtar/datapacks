...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:mossy_cobblestone_stairs"} run scoreboard players set #special try_dis_bid 266
execute if data storage tryashtar:dispense_everything item{id:"minecraft:mossy_stone_brick_stairs"} run scoreboard players set #special try_dis_bid 267
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:polished_andesite_stairs"} run scoreboard players set #special try_dis_bid 270
