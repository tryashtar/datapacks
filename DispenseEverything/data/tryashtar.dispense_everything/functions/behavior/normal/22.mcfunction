...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:birch_stairs"} run scoreboard players set #special try_dis_bid 257
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:brick_stairs"} run scoreboard players set #special try_dis_bid 258
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:oak_trapdoor"} run scoreboard players set #special try_dis_bid 293
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:stone_stairs"} run scoreboard players set #special try_dis_bid 285
