...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:cocoa_beans"} run function tryashtar.dispense_everything:behavior/special/cocoa_beans
