...
execute if block ~ ~-1 ~ #minecraft:bamboo_plantable_on if data storage tryashtar:dispense_everything item{id:"minecraft:bamboo"} run function tryashtar.dispense_everything:behavior/special/bamboo
...
execute if data storage tryashtar:dispense_everything item{id:"minecraft:hopper"} run function tryashtar.dispense_everything:behavior/special/hopper
