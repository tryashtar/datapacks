...
execute if block ~ ~ ~ #minecraft:walls[east=false,north=true,south=true,up=true,west=false] run tag @s add try_dis_ok
execute if block ~ ~ ~ #minecraft:walls[east=false,north=true,south=true,up=false,west=false] run tag @s add try_dis_ok
