...
execute as @e[type=experience_orb,x=0,y=0,z=0,sort=nearest] at @s positioned ~ ~-0.01 ~ if block ~ ~ ~ hopper[enabled=true]{TransferCooldown:0} align xyz positioned ~ ~0.6875 ~ if entity @s[dy=0] run function tryashtar.dispense_everything:xp_hopper
