...
execute if entity @s[nbt={Item:{id:"minecraft:lily_pad"}}] run setblock ~ ~ ~ lily_pad
...
execute if entity @s[nbt={Item:{id:"minecraft:painting"}}] run setblock ~ ~ ~ painting
execute if entity @s[nbt={Item:{id:"minecraft:oak_sign"}}] run setblock ~ ~ ~ oak_sign
execute if entity @s[nbt={Item:{id:"minecraft:redstone"}}] run setblock ~ ~ ~ redstone
