...
execute if entity @s[nbt={Item:{id:"minecraft:spruce_pressure_plate"}}] run setblock ~ ~ ~ spruce_pressure_plate
execute if entity @s[nbt={Item:{id:"minecraft:jungle_pressure_plate"}}] run setblock ~ ~ ~ jungle_pressure_plate
execute if entity @s[nbt={Item:{id:"minecraft:acacia_pressure_plate"}}] run setblock ~ ~ ~ acacia_pressure_plate
