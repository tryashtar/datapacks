...
execute if entity @s[nbt={Item:{id:"minecraft:pink_tulip"}}] run setblock ~ ~ ~ pink_tulip
execute if entity @s[nbt={Item:{id:"minecraft:cornflower"}}] run setblock ~ ~ ~ cornflower
...
execute if entity @s[nbt={Item:{id:"minecraft:comparator"}}] run setblock ~ ~ ~ comparator
...
execute if entity @s[nbt={Item:{id:"minecraft:item_frame"}}] run setblock ~ ~ ~ item_frame
