...
execute if entity @s[nbt={Item:{id:"minecraft:redstone_torch"}}] run setblock ~ ~ ~ redstone_torch
...
execute if entity @s[nbt={Item:{id:"minecraft:beetroot_seeds"}}] run setblock ~ ~ ~ beetroot_seeds
execute if entity @s[nbt={Item:{id:"minecraft:music_disc_cat"}}] run setblock ~ ~ ~ music_disc_cat
execute if entity @s[nbt={Item:{id:"minecraft:music_disc_far"}}] run setblock ~ ~ ~ music_disc_far
